...
function idealist_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here to display on the right side of your posts. For example, use the Recent Posts and Recent Comments widgets to engage your readers. Or, use the Text widget to display custom info and special announcments.', 'idealist' ),
		'class'			=> 'minimal',
...
function idealist_scripts() {
	...
	wp_enqueue_script( 'custom-js', get_template_directory_uri() . '/assets/js/custom.min.js', array(), IDEALIST_VERSION, true );
